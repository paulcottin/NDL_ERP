...
public class Personne extends PhysicalTable{
	...
	//TODO refactoring de code pour distinguer les classes qui représentent les tables et celles qui représente une valeur
...
//		statuts = FXCollections.observableArrayList();
	...
	//TODO checker si ça fonctionne encore avec des données vides et comment réagir dans ces cas
	private void habillageDonnees() throws ColonneNotfoundException, TableNotFoundException, BadRequestException, DefaultException {
		for (LigneTest ligne : lignesTest) {
			...
			//On donne le statut
			statut = new Statut(bdd, (int) ligne.getData().get(Statut.ID).getValue());
